...
<section class="bg-gradient-to-br from-green-50 to-blue-50 py-20">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
            Thank you {{ $member->name }} for joining our community! You're now part of an amazing network of readers and thinkers who believe in the power of shared knowledge.
        </p>
        
        <!-- Book Reference -->
        <div class="bg-white rounded-xl shadow-lg p-6 max-w-sm mx-auto mb-8">
            <div class="flex items-center space-x-4">
                <div class="w-16 h-20 bg-gradient-to-br from-blue-100 to-purple-100 rounded flex-shrink-0 flex items-center justify-center">
...
<section class="py-16 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-900 mb-4">What Happens Next?</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-blue-50 rounded-xl p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Stay Connected</h3>
            ...
            <div class="bg-purple-50 rounded-xl p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Discover More Books</h3>
                <p class="text-gray-700 mb-4">
                    Explore other books that have been shared with our community and see the amazing network we're building together.
                </p>
                <a href="{{ route('books') }}" class="inline-flex items-center text-purple-600 hover:text-purple-700 font-medium">
                    Browse our books
